...
func (l *Logger) Error(format string, v ...interface{}) {
	...
	sharedfrp.Log(sharedfrp.Error, fmt.Sprintf(l.prefixString+format, v...))
}

func (l *Logger) Warn(format string, v ...interface{}) {
	log.Log.Warn(l.prefixString+format, v...)
	sharedfrp.Log(sharedfrp.Warn, fmt.Sprintf(l.prefixString+format, v...))
}

func (l *Logger) Info(format string, v ...interface{}) {
	log.Log.Info(l.prefixString+format, v...)
	sharedfrp.Log(sharedfrp.Info, fmt.Sprintf(l.prefixString+format, v...))
}

func (l *Logger) Debug(format string, v ...interface{}) {
	log.Log.Debug(l.prefixString+format, v...)
	sharedfrp.Log(sharedfrp.Debug, fmt.Sprintf(l.prefixString+format, v...))
}

func (l *Logger) Trace(format string, v ...interface{}) {
	log.Log.Trace(l.prefixString+format, v...)
	sharedfrp.Log(sharedfrp.Trace, fmt.Sprintf(l.prefixString+format, v...))
}
